...
<head>
  ...
  <title>SI STMIK Dharma Wacana</title>
...
<!-- NAVBAR -->
<nav id="main-navbar" class="navbar navbar-expand-lg navbar-dark bg-dark py-3">
  <div class="container pb-3">
    <a class="navbar-brand" href="{{ url('/') }}">
      <span>STMIK Dharma Wacana</span>
    </a>
